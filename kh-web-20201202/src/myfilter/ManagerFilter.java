...
public class ManagerFilter implements Filter {
	...
	public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain)
		...
		if(mid== null || !mid.contentEquals("manager")) { //로그인하지 않은 경우
			rd = request.getRequestDispatcher("./filter/login)fail.jsp");
	...
	@Override
	public void destroy() {
		System.out.println("maganer login filter가 종료되었습니다");
	}
