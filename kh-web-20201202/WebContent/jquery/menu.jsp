...
<ol>
	...
	<li><a href ='index.jsp?inc=./jquery/func_ajax.jsp'>AJAX 함수호출</a></li>
	<li><a href ='index.jsp?inc=./jquery/func_ajax_json.jsp'>AJAX 함수호출(JSON)</a></li>
	<li><a href ='index.jsp?inc=./jquery/func_load.jsp'>LOAD함수호출</a></li>
</ol>
</body>
</html>