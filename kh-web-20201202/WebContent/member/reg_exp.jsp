...
<script>
	...
	try{
		...
		reg = /^[A-Z][a-zA-Z0-9]+$/;
		document.write("reg = /^[A-Z][a-zA-Z0-9]+$/ --> 첫글자는 무조건 대문자이고 영숫자(\w:영숫자)");
		document.write(msg(reg, str1));
		document.write(msg(reg, str2));
		document.write(msg(reg, str3));
		document.write(msg(reg, str4));
		...
		document.write("reg=/\d{2,3}-\d{3,4}-\d{4}/");
		document.write(msg(reg, str1));
		document.write(msg(reg, str2));
		document.write(msg(reg, str3));
		document.write(msg(reg, str4));
